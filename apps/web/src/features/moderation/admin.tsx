...
type Statistics = { users: number; activeUsers: number; suspendedUsers: number; openReports: number; messagesToday: number; newUsersToday: number };
...
export function Admin() {
  ...
  async function reload(): Promise<void> {
    try {
      const [nextReports, nextUsers, nextStatistics] = await Promise.all([api.request<Report[]>('reports'), api.request<User[]>('reports/users'), api.request<Statistics>('reports/statistics')]);
